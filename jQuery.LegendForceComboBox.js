...
/*
  ...
  under the input field similiar to a select field

  Feel free to use this any way you feel and if it is something you like please throw a little credit my way
  Originally created by Dave Hahn for use by Legend Boats of Canada
*/
...
Options:
  ...
  minTextLength: "the minimum number of characters to be entered before the search function fires" - DEFAULT = 3
